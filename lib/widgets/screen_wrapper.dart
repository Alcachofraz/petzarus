...
class ScreenWrapper extends StatefulWidget {
  ...
  /// Callback to when user pops this page's context. If this function
  /// returns false, the page context will not be popped.
...
class _ScreenWrapperState extends State<ScreenWrapper> {
  ...
  Widget build(BuildContext context) {
    SystemChrome.setPreferredOrientations(
      widget.allowLandscape ? DeviceOrientation.values : [DeviceOrientation.portraitUp, DeviceOrientation.portraitDown],
    );
        ...
        return WillPopScope(
          onWillPop: () async {
            if (widget.onBack != null) {
              return await widget.onBack!.call();
            } else {
              return true;
            }
          },
          child: SafeArea(
            child: Scaffold(
              ...
              body: widget.backgroundImage == null
                  ? widget.body
                  : Container(
